...
if __name__ == '__main__':
    ...
    # Data-related
    parser.add_argument('-d', '--data_type', type=str, default='ccg', choices=['ccg', 'replica','spectus','humob','replica'])
    ...
    # Model-related
    parser.add_argument('-m', '--model_type', type=str, default='LSTM', choices=['VAE', 'LSTM'])
